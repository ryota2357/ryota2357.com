...
12/27 日修正:
<del>[azooKey](https://azookey.com/) がライブ変換に対応しているので良さそう思ったのですが、ターミナル上 (Neovim 上) でうまく動かないという話を聞いていて試せてません</del>
[azooKey](https://azookey.com/) がライブ変換に対応しており、ローマ字テーブルのカスタマイズがきそうです。
ただし、ターミナル上での入力に関して、普通に日本語入力できるものの、Terminal.app 以外のターミナルの場合、変換確定済みの左側文字列をかな漢字変換に活用できないようです。
良さそうなので、試してみたいなと思っています。
[(Twitter 上にて flowksms さんに教えていただきました。ありがとうございます。)](https://x.com/flowksms/status/2004366601672646750?s=20)
